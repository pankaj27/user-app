...
//
//     final audioSectionListModel = audioSectionListModelFromJson(jsonString);

import 'dart:convert';

AudioSectionListModel audioSectionListModelFromJson(String str) =>
    AudioSectionListModel.fromJson(json.decode(str));

String audioSectionListModelToJson(AudioSectionListModel data) =>
    json.encode(data.toJson());

class AudioSectionListModel {
  int? status;
  String? message;
  List<Result>? result;
  int? totalRows;
  ...
  factory AudioSectionListModel.fromJson(Map<String, dynamic> json) =>
      AudioSectionListModel(
        status: json["status"],
