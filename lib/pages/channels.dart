...
import 'package:bharatmandiram/model/channelsectionmodel.dart' as list;
import 'package:bharatmandiram/model/channelsectionmodel.dart' as banner;
...
import 'package:bharatmandiram/players/player_vimeo.dart';
...
class ChannelsState extends State<Channels> {
            ...
            child: CarouselSlider.builder(
              ...
              options: CarouselOptions(
                ...
                onPageChanged: (val, _) async {
                  channelSectionProvider.setCurrentBanner(val);
                },
              ),
              itemBuilder:
  ...
  /* ========= Open Player ========= */
  Future<void> openPlayer(List<banner.LiveUrl>? sectionBannerList, int index) async {
