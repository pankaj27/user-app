...
import 'package:bharatmandiram/model/audiosectionlistmodel.dart' as list;
...
class WebAudioBookState extends State<WebAudioBook> {
  ...
  @override
  void initState() {
    audioSectionProvider = Provider.of<AudioSectionDataProvider>(
      context,
      listen: false,
    );
    ...
    return Stack(
      children: [
        Scaffold(
          ...
          body: SafeArea(child: _buildChannelPage()),
        ),
            ...
            child: CarouselSlider.builder(
              ...
              options: CarouselOptions(
                ...
                onPageChanged: (val, _) async {
                  audioSectionProvider.setCurrentBanner(val);
                },
              ),
              itemBuilder:
